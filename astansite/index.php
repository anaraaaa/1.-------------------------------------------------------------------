...
*/
$hour = (int) strftime(4); // Инициализируем переменную для приветствия
$a = 0;
$b = 6;
$c = 12;
$d = 18;
...
$welcome = '';
 if ($hour > $a and $hour <= $b): { 
     $welcome = 'доброй ночи';
 } elseif ($hour > $b and $hour <= $c):
{$welcome = 'доброго утра';}
elseif ($hour > $c and $hour <= $d):
{$welcome = 'доброго дня';}
 elseif ($hour > $d and $hour <= $e):
{$welcome = 'доброго вечера';};
else:
{$welcome = 'доброй ночи';}
endif; // Установка локали и выбор значений даты
...
<body>
  ...
  <div id="content">
	...
	<blockquote>
 <?php echo "Сегодня $day число, $mon месяц, $year год $dhr часов.";
 ?>
</blockquote>
